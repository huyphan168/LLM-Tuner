...
from essai.datasets import build_collator
...
def main():
    ...
    omega_config = OmegaConf.load(os.path.abspath(sys.argv[1]))

    ModelArguments, DataTrainingArguments, TrainingArguments = build_arguments(omega_config)
